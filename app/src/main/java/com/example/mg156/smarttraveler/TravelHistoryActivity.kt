...
class TravelHistoryActivity : AppCompatActivity() {
    ...
    fun setVenueDetails() {
        ...
        profileRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                //activity_view_pager.setPageTransformer(true, WindmillTransformer())
                //activity_view_pager.setPageTransformer(true, ScaleTransformer())
                activity_view_pager.setPageTransformer(true, TranslationYTransformer())
                //activity_view_pager.setPageTransformer(true, RaiseFromCenterTransformer())
    ...
    inner class VenuePagerAdapter ( fragmentManager : FragmentManager) : FragmentStatePagerAdapter( fragmentManager ) {
        ...
        override fun getItem (position: Int ): Fragment {
            ...
            ,planDetailsList[position].planEndTime,planDetailsList[position].planPreference, position)
        }
